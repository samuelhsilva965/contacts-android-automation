...
def _open_create_contact(driver, home_page: ContactsPage) -> None:
    """Garante home, abre a tela de criação e fecha o diálogo de conta se aparecer."""
...
def _assert_home_contacts_unchanged(
    driver,
    home_page: ContactsPage,
    home_with_contact: HomeWithContactPage,
    names_before: list[str],
) -> None:
    """Valida retorno à home sem alteração na lista de contatos."""
    ensure_on_contacts_home(driver)
    assert home_page.get_toolbar_title_text() == "Contatos"
    names_after = _get_contact_names(home_page, home_with_contact)
    assert names_after == names_before, (
        f"Lista de contatos mudou. Antes: {names_before}, Depois: {names_after}"
    )
...
class TestCreateContact:
    ...
    def test_cancel_contact_creation_empty_form(
        self,
        driver,
        ...
        """
        with allure.step("Capturar lista de contatos antes do fluxo"):
            names_before = _get_contact_names(home_page, home_with_contact)

        with allure.step("Clicar em criar novo contato"):
            _open_create_contact(driver, home_page)

        with allure.step("Clicar em cancelar"):
            create_new_contact.click_btn_cancel()

        with allure.step("Validar retorno à home sem novos contatos"):
            _assert_home_contacts_unchanged(
                driver, home_page, home_with_contact, names_before
            )
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_cancel_contact_creation_with_filled_fields(
        self,
        driver,
        create_new_contact: CreateContactPage,
        home_page: ContactsPage,
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_create_contact_with_empty_form_fails(
        self,
        driver,
        create_new_contact: CreateContactPage,
        home_page: ContactsPage,
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_validate_create_contact_screen_placeholders(
        self,
        driver,
        home_page: ContactsPage,
        validator_new_contact: ValidationNewCreateContact,
        create_new_contact: CreateContactPage,
    ):
        """
    ...
    def test_change_phone_type_shows_correct_label(
        self,
        driver,
        home_page: ContactsPage,
        create_new_contact: CreateContactPage,
    ...
    def test_change_email_type_shows_correct_label(
        self,
        driver,
        home_page: ContactsPage,
        create_new_contact: CreateContactPage,
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_new_contact_first_name_autofocus(
        self,
        driver,
        home_page: ContactsPage,
        create_new_contact: CreateContactPage,
    ...
    def test_create_contact_with_partial_data(
        self,
        driver,
        home_page: ContactsPage,
        create_new_contact: CreateContactPage,
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_create_contact_with_all_fields_filled(
        self,
        driver,
        home_page: ContactsPage,
        create_new_contact: CreateContactPage,
